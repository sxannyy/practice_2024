...
async def test_delete_user(client, create_user_in_database, get_user_from_database):
    ...
    resp = client.delete(
        f"/user/delete_user/?user_id={user_data['user_id']}",
...
async def test_delete_user_not_found(client, create_user_in_database):
    ...
    resp = client.delete(
        f"/user/delete_user/?user_id={user_id_not_exists_user}",
        headers=create_test_auth_headers_for_user(user_data["email"]),
    )
...
async def test_delete_user_bad_cred(client, create_user_in_database):
    ...
    user_id = uuid4()
    resp = client.delete(
        f"/user/delete_user/?user_id={user_id}",
...
async def test_delete_user_by_privilege_roles(
    ...
    await create_user_in_database(**user_data)
    resp = client.delete(
        f"/user/delete_user/?user_id={user_data_for_deletion['user_id']}",
        headers=create_test_auth_headers_for_user(user_data["email"]),
    )
    assert resp.status_code == 200
...
async def test_delete_another_user_error(
    ...
    resp = client.delete(
        f"/user/delete_user/?user_id={user_for_deletion['user_id']}",
